...
<head>
    ...
    <title>Informasi - PAUD ATTHOHIRIYYAH</title>
...
<body>
    ...
    <header class="page-header">
        <div class="container">
            ...
            <p>Berita terbaru dan pengumuman resmi PAUD ATTHOHIRIYYAH</p>
        </div>
    </header>
        ...
        <div class="info-grid">
            ...
            <div class="news-card">
                <div class="news-content">
                    <span class="news-category">{{ $info->category ?? 'Info' }}</span>
                    <h3 class="news-title">{{ $info->title }}</h3>
                    <p style="color: var(--text-muted); margin-bottom: 1.5rem;">{{ Str::limit($info->description, 150) }}</p>
                    <a href="/information/{{ $info->slug }}" class="news-link">Selengkapnya <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>
            @endforeach
        </div>
